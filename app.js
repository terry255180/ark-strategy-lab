...
function shouldPauseBuying(state) {
  const {trend, arkHistory, cnn=0, rsi=0, bias20D=0, marketPosition="MID"} = state;
  ...
  const extremeOverheat=cnn>=80&&rsi>=80&&bias20D>=10&&marketPosition==="HIGH";
